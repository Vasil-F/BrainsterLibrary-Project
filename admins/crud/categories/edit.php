...
<body class="pb-5">
    <nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div>
                <a href="../categories/view.php" class="btn btn-primary p-1 ml-2">Go back</a>
            </div>
            ...
            <form class="text-left font-weight-bold">
                <div class="row">
                    <div id="updateForm" class="col-md-6 offset-md-3">
                        ...
                        <input class="form-control" name="category" id="category" value="<?= $data['category'] ?>">
    ...
    <script src="../../../public/js/updateCategory.js"></script>
