...
<body>
    <nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button id="viewCreateButton" class="btn btn-warning ml-4">Create category</button>
            <button id="viewCategoriesButton" class="btn btn-warning ml-4 d-none">View categories</button>
    ...
    <div class="container-fluid">
        <table id="tableView" class="table  w-100 mb-5">
            <thead class="thead-dark">
                <tr>
                    <th scope="col">#</th>
                    <th scope="col">Category</th>
                    <th scope="col">category_deleted</th>
                ...
                <?php while ($data = $stmt->fetch()) { ?>
                    <tr style="border-bottom: solid 2px lightgoldenrodyellow;">
                        ...
                        <td>
                            ...
                            <?php if ($data['category_deleted'] == '1') { ?>
        ...
        <form class="text-left font-weight-bold">
            <div class="row">
                <div id="createForm" class="col-md-6 offset-md-3">
                    <label class="mt-2" for="category">Add new category</label>
                    <input class="form-control" name="category" id="category">
                    <button class="btn btn-block btn-primary mt-4" id="createCategoryButton">CREATE CATEGORY</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script src="../../../public/js/createCategory.js"></script>
    <script src="../../../public/js/deleteCategory.js"></script>
    <script src="../../../public/js/restoreCategory.js"></script>
