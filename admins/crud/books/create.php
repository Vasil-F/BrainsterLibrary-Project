...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($flag) {
            ...
            $sql = "INSERT INTO books (book_title, author_id, year_published, pages, cover, category_id, book_deleted)
            VALUES (:book_title, :author_id, :year_published, :pages, :cover, :category_id, :book_deleted)";
