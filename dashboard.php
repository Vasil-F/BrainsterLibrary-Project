...
<body class="pb-5">
  <nav style=" background-color: rgb(40, 11, 11); " class="navbar navbar-expand-lg navbar-dark mb-3">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div id="searchForm" class="form-inline my-2 my-lg-0 mx-auto">
  ...
  <div id="filterContainer" class="filterContainer container-fluid px-5 flex-wrap d-none text-white  justify-content-around animate__animated animate__fadeInDown">
